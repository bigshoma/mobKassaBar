...
Процедура ПриОткрытии(Отказ)
	...
	ПодключитьОбработчикОжидания("Подключаемый_СостояниеККТ", 0.1, Истина);
...
&НаКлиенте
Процедура Подключаемый_СостояниеККТ()
	...
	Если НЕ МенеджерОборудованияКлиент.ВыполнитьПолучениеТекущегоСостоянияФискальногоУстройства(
	...
	Если НЕ ЕстьОшибки Тогда
		...
		ЗаполнитьЗначенияСвойств(ЭтаФорма, ВыходныеПараметры.ПараметрыСостояния);
