...
Процедура Подключаемый_ВыполнитьОтчет()
	...
	ЛогированиеКлиентСервер.ЗаписатьСобытие("ОтчетОТекущемСостоянииРасчетов");
	
	Если НЕ МенеджерОборудованияКлиент.ВыполнитьФормированиеОтчетаОТекущемСостоянииРасчетов(
		...
		ЛогированиеКлиентСервер.ЗаписатьСобытие("ОтчетОТекущемСостоянииРасчетов", "Ошибка - " + ВыходныеПараметры.ТекстОшибки);
...
Процедура ОтобразитьСтраницуОтчетОТекущемСостоянииРасчетов()
	...
	Элементы.СтраницыФормы.ТекущаяСтраница = Элементы.СтраницаОтчетОТекущемСостоянииРасчетов;
