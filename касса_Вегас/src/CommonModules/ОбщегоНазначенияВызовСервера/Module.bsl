...
Функция ОбработатьЗапускПриложения() Экспорт
	...
	Если ПервыйЗапуск Тогда
		...
		Константы.СпособФорматноЛогическогоКонтроля.Установить(
			Перечисления.СпособыФорматноЛогическогоКонтроля.РазделятьСтроки
		);
...
Процедура ОбработатьПервыйЗапуск() Экспорт
...
Функция ПолучитьСостояниеФоновогоЗадания(ИдентификаторЗаданияВФоне) Экспорт
	
	Задание = НайтиЗаданиеПоИдентификатору(ИдентификаторЗаданияВФоне);
...
Функция ПолучитьСообщениеОбОшибке(ИдентификаторЗаданияВФоне) Экспорт
...
Функция УстановленПарольАдминистративногоРежима() Экспорт
	...
	Возврат ОбщегоНазначения.УстановленПарольАдминистративногоРежима();
