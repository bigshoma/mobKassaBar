...
//   Булево
//
Функция ИспользуютсяРасчетыСКлиентами() Экспорт
	
	Возврат ПолучитьЗначениеКонстанты("ИспользоватьРасчетыСКлиентами");
...
Функция ШрифтПриложения() Экспорт
	...
	Если ОбщегоНазначенияПовтИсп.ЭтоПланшет() Тогда
		РазмерШрифтаПриложения = РазмерШрифтаПриложения + 2;
	КонецЕсли;
...
Функция ШаблонВыводаНаименованияТовара() Экспорт
	
	Возврат ПолучитьЗначениеКонстанты("ШаблонВыводаНаименованияТовара");
	
КонецФункции

//НАСТРОЙКИ СИНХРОНИЗАЦИИ

Функция ИспользуетсяОбменВФоне() Экспорт
	
	Если НЕ ЗначениеНастроекВызовСервераПовтИсп.ЭтоАвтономныйРежим()
		И ЗначениеНастроекВызовСервераПовтИсп.ЗаполненыПараметрыСинхронизации()
